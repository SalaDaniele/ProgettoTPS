...
namespace server
{
    class Game
    {
        ...
        public void Start()
        {
            Console.WriteLine(  "awfjkjwajfwafwjiabnwfanfowanifanbifawbnwfbuowabfuoabfueoafbjoabfebfhesbfu");
            while (!IsGameOver())
            {
                ...
                Console.WriteLine($"Player {currentPlayer.PlayerId} move: {playerMove}");
